...
Generate a concise, teacher-facing resource in Markdown with clear headings and bullet points.
...
Requirements:
- Level: ${hints?.level ?? "On Grade Level"}
- Duration: ${hints?.duration ?? "60 min Lesson"}
- Tone: Supportive, teacher-friendly, practical.
- Include Differentiated Instruction, Gradual Release (I/We/You do), and 1–2 collaborative structures (stations or think-pair-share).
